...
<head>
  ...
  <title>Home - HermPharmCompany</title>
  <!-- Bootstrap CSS -->
  <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet">
  <style>
    .navbar {
      background-color: #24dc16; /* Change header color to green */
    }
    body {
      background-color: rgb(112, 201, 34);
    }
    footer {
      position: fixed;
      bottom: 0;
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <a class="navbar-brand" href="#">HerbPharmaCompany</a>
  ...
  <div class="container mt-5">
    <div class="row">
      <div class="col-md-8">
        <h1>Welcome to HerbPharmaCompany</h1>
        <p>Welcome to HerbPharmaCompany, your trusted source for high-quality pharmaceutical products. We are dedicated to improving the health and well-being of our customers by providing safe and effective medications.</p>
      ...
      <div class="col-md-4">
        <img src="bg.jpeg" class="img-fluid" alt="Pharmacy Image">
        <img src="bg2.jpeg" class="img-fluid">
        <img src="bg3.jpeg"  class="img-fluid">
      </div>
    </div>
  </div>
  ...
  <footer class="bg-dark text-white text-center">
    <div class="container">
      <p>&copy; 2024 HerbPharma. All rights reserved. BY MERCY A (212223110027)</p>
    </div>
  </footer>
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>About HerbPharmaCompany</title>
  <!-- Bootstrap CSS -->
  <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet">
  <style>
    body {
...
<body>
  ...
  <footer>
    <div class="container">
      <p>&copy; 2024 HerbPharmaCompany. All rights reserved. BY MERCY A (212223110027)</p>
    </div>
  </footer>
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Products - HerbPharmaCompany</title>
  <!-- Bootstrap CSS -->
  <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet">
  <style>
    body {
  ...
  <div class="container mt-5 content">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="card-deck">
          <div class="card">
            <img src="cream.jpeg"  class="card-img-top" alt="Product 1" width="200" height="200">
            <div class="card-body">
          ...
          <div class="card">
            <img src="pharmy.jpeg" class="card-img-top" alt="Product 2" width="200" height="200">
            <div class="card-body">
          ...
          <div class="card">
            <img src="seerum.jpeg" class="card-img-top" alt="Product 3" width="200" height="200">
            <div class="card-body">
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Contact Us - HerbPharmaCompany</title>
  <!-- Bootstrap CSS -->
  <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet">
  <style>
    body {
        background-color: rgb(152, 197, 221);
    }
  </style>
</head>
<body>
...
## OUTPUT:
![alt text](<Screenshot 2024-05-08 222402.png>)
